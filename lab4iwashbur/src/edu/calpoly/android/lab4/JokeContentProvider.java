...
public class JokeContentProvider extends ContentProvider {
	...
	static {
		...
		sURIMatcher.addURI(AUTHORITY, BASE_PATH + "/filter/#", JOKE_FILTER);
	}
	...
	public int delete(Uri uri, String selection, String[] selectionArgs) {
		...
		case JOKE_ID:
		   ...
		   numRowsDeleted = sqlDB.delete(JokeTable.DATABASE_TABLE_JOKE, JokeTable.JOKE_KEY_ID + "=" + id, null);
		   break;
	...
	public int update(Uri uri, ContentValues values, String selection,
      ...
      case JOKE_ID:
         String id = uri.getLastPathSegment();
         numRowsDeleted = sqlDB.update(JokeTable.DATABASE_TABLE_JOKE, values, JokeTable.JOKE_KEY_ID + "=" + id, null);
         break;
